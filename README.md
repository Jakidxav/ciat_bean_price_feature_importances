...
## Jupyter Notebooks
The Jupyter Notebooks are numbered with an order that I suggest you run them in. However, since I have saved all of the data at each stage, it is possible to skip to the last Notebook `7_feature_importances.ipynb` if you wanted to. If you want to look through the Notebooks without running them, make sure you go through all of the Notebooks with `_eda.ipynb` at the end first, in no particular order, but then continue with Notebooks 5, 6 and 7.
